  ...
  return (
    <section className='flex justify-center bg-primary-50 bg-dotted-pattern bg-contain'>
        <div className='grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl'>
            ...
            width={600}
            height={600}
            className='h-full min-h-[150px] object-center object-cover'
            />
            <div className='flex w-full flex-col gap-8 p-5 md:p-10 mt-10'>
                ...
                <div className='p-regular-20 flex items-center gap-3'>
                    ...
                    height={28}
                    />
                     <p className='p-medium-16 lg:p-reguluar-20'>{event.location}</p>
                </div>
                </div>
                <div className='flex flex-col gap-2'>
                    <p className='p-bold-20 text-grey-600'>About this event:</p>
                    <p className='p-medium-17 lg:p-regular-18'>{event.description ? event.description : (
                        'Description not available for this event.'
                    )}</p>
                </div>
            </div>
        </div>
