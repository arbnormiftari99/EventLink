    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="w-full">
            <FormControl>
            <div className="flex-center h-[60px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                      <Image
          ...
          <FormItem className="w-full">
            ...
            <div className="flex-center h-[60px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                      <Image
                        ...
                        className="filter-grey"
                      />
                    <Input type="number" placeholder="Price" {...field} className="p-regular-16 border-0 bg-grey-50 outline-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0" />
